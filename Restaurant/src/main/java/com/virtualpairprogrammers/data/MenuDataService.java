...
public class MenuDataService {
	...
	public MenuDataService() {
		...
		menuItems.add(new MenuItem(4, "Lamb Shank",
				...
				MenuCategory.MAIN_COURSE, 12.99));
		menuItems.add(new MenuItem(5, "Sea Bass",
				...
				MenuCategory.MAIN_COURSE, 11.99));
		...
		menuItems.add(new MenuItem(10, "Coffee", "Espresso, Americano, Latte or Capuccino? Tell us how you like it!",
				MenuCategory.DRINK, 2.99));
		menuItems.add(
				new MenuItem(11, "Tea", "We have a full range of classic and herbal teas.", MenuCategory.DRINK, 2.99));
	}
